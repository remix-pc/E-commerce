...
namespace ProjetoJornada.Models
{
    public class Produto
    {
        ...
        public static Produto Puxardescricao(int id)
        {
            ...
            try
            {
                ...
                while (leitor.Read())
                {
                    ...
                    /*string nome, string descricao, float preco, int quant, int id/*/
        ...
        public static void AdicionarAoCarrinho(string cpf, int IDProduto, string pNome, float pPreco,int pQuantidade)
        {
            // esse metodo ira verificar a tabela de carrinho , e se nao houver tal item com esses parametros na mesma ira adiciona - lo

            MySqlConnection con = new MySqlConnection(conexao);

            //com o objeto completo pegamos todos os seus pavalores aplicamos a variaveis e adivionamao s na tabel ade carrinho 
            ...
            try
            {
                ...
                if (!leitor.HasRows)
                {
                    ...
                    MySqlCommand query = new MySqlCommand("insert into carrinho(ID_Produto, CPFCliente,nome,preco,quantidade) VALUES(@idProduto,@cpf,@pNome,@pPreco,@pQuantidade)", con);
                    ...
                    query.Parameters.AddWithValue("@pQuantidade", pQuantidade);
