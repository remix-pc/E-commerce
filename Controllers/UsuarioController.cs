...
namespace ProjetoJornada.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Cadastrar(string cpf, string nome, string email, string nomeUsuario, string senha)
        {
            Usuario u = new Usuario(cpf, nome, email, nomeUsuario, senha, 0);
