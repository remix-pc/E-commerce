...
namespace ProjetoJornada.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public IActionResult Cadastrar(string nome, string descricao, float preco, int quant, int id)
        {
        ...
        public IActionResult AdicionarAoCarrinho(string cpf, int IDProduto, string pNome, float pPreco, int pQuantidade)
        {
            if (cpf != null)
            {

                Produto.AdicionarAoCarrinho(cpf, IDProduto, pNome, pPreco,pQuantidade);
                return RedirectToAction("Teladescricao", "Produto", new {id = IDProduto });
